...
public class Producto {
	...
	@NotEmpty(message = "\"Nombres de Productos permitidos entre 2 y 80 caracteres, no se permiten Marcas vacias\"")
	...
	@Min(value=1, message = "Valor minimo permitido es de 1")
